...
- 플랜 branch, review, merge workflow가 변경 거버넌스를 제공한다. [SRC-20260721-avo]
- Codegen은 여러 분석 목적지를 감싼 이벤트 함수를 생성한다. [SRC-20260721-avo]
- Inspector는 값 대신 schema를 관측해 privacy 부담을 줄인다. [SRC-20260721-avo]
- 사람이 플랜을 작성하고 호출 위치를 구현하며 화면을 눌러 검증한다. [SRC-20260721-avo]
