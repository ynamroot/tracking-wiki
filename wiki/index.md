...
- [[buyer-and-champion|구매자와 champion 가설]] - 예산을 승인하는 사람과 내부 도입을 밀 사람을 구분한다.
- [[tracking-qa-workflow|트래킹 QA 운영 workflow]] - 배포 전후의 검증과 문제 대응 흐름을 설명한다.
...
- [[codegen-and-tracking-plan-workflow|Codegen과 tracking plan workflow]] - 트래킹 플랜에서 코드를 자동 생성하는 패턴을 정리한다.
